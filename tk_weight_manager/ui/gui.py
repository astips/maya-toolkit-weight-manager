...
class MainDialog(QtWidgets.QDialog, manager_qt.Ui_skinClusterManager_Dialog):
    ...
    def __connect_cmd(self):
        ...
        self.skinClusterManager_one_listWidget.itemClicked.connect(
            self.skinClusterManager_one_listWidget_itemClicked_cmd)
        self.skinClusterManager_one_listWidget.itemDoubleClicked.connect(
            self.skinClusterManager_one_listWidget_itemDoubleClicked_cmd)
        self.skinClusterManager_two_listWidget.itemClicked.connect(
            self.skinClusterManager_two_listWidget_itemClicked_cmd)
        self.skinClusterManager_two_listWidget.itemDoubleClicked.connect(
            self.skinClusterManager_two_listWidget_itemDoubleClicked_cmd)
        self.skinClusterManager_export_pushButton.clicked.connect(self.skinClusterManager_export_pushButton_cmd)
        self.skinClusterManager_exportComponents_pushButton.clicked.connect(
            self.skinClusterManager_exportComponents_pushButton_cmd)
        self.skinClusterManager_import_pushButton.clicked.connect(self.skinClusterManager_import_pushButton_cmd)
        self.skinClusterManager_batchImport_pushButton.clicked.connect(
            self.skinClusterManager_batchImport_pushButton_cmd)
        self.skinClusterManager_getInfluenceFromWeightData_pushButton.clicked.connect(
            self.skinClusterManager_getInfluenceFromWeightData_pushButton_cmd)
        ...
        self.skinClusterManager_getInfluence_pushButton.clicked.connect(
            self.skinClusterManager_getInfluence_pushButton_cmd)
        self.skinClusterManager_resetBindPose_pushButton.clicked.connect(
            self.skinClusterManager_resetBindPose_pushButton_cmd)
        self.skinClusterManager_holdInfluence_pushButton.clicked.connect(
            self.skinClusterManager_holdInfluence_pushButton_cmd)
        self.skinClusterManager_unHoldSelectedInfluence_pushButton.clicked.connect(
            self.skinClusterManager_unHoldSelectedInfluence_pushButton_cmd)
        self.skinClusterManager_removeUnusedInfluence_pushButton.clicked.connect(
    ...
    def skinClusterManager_folder_pushButton_cmd(self):
        ...
        if value:
            if os.path.exists(os.path.join(self.config['root'], value)):
                ...
                newItem = QtWidgets.QListWidgetItem(self.skinClusterManager_one_listWidget)
    ...
    def skinClusterManager_path_LineEdit_cmd(self):
        try:
            self.skinClusterManager_path_LineEdit.setText(str(self.pathing))
            ...
            if method == 'single':
                ...
                for item in os.listdir(self.pathing):
                    ...
                    if os.path.isfile(subPath) and fnmatch.fnmatch(item, '*.xml'):
                        newItem = QtWidgets.QListWidgetItem(self.skinClusterManager_two_listWidget)
